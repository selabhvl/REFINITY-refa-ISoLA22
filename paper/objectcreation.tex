...
object $o_h$, such that (1) for all $o' < o$ the object $o'$ is allocated (i.e., its \codein{<allocated>} field is set to true in the heap mapped from the unique \codein{heap} variable), and
