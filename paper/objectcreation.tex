...
\vsnote*{@EK: There's a sentence here missing bridging from previous paragraph to definition.}{Probably needs a sentence that technical details are in the KeY-book; maybe pull up footnote?}
...
\vsnote*{@EK: see above.}{We adapt the previous definition to take into account the types of objects.}
...
\vsnote*{@EK/Ole: Can someone clarify why/where this is not covered by/included in Dom's encoding on p.231 of the thesis? Or in the AE-papers?}{%
A more limited case is shown as correct in Steinhöfel's \rname{Slide Statement} proof \cite{steinhoefel-20}, p.231.
}
...
\vsnote*{@EK(?): See above, kinda leaves hanging there about what is the conclusion.}{%
