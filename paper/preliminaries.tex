...
We summarize how AE is implemented in \Refinity{} by showing how to specify a method \rcode{void n()} where we do not want to specify the exact content of its method body.
