...
e.g.\ Fowler's \rname{Replace Array with Object}~\cite[p.186]{fowler:refactoring} \rname{Replace Primitive with Object}~\cite{fowler:refactoring2nd}.
...
Encoding observability through traces as per the previous section will obviously solve this issue, as the observables would ideally talk \vsnote*{of ...?}{about the constituent parts}.
