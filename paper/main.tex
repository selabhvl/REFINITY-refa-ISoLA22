...
The first new refactoring, Hide Delegate, \vsnote*{inner classes not actually visible; remove!}{harnesses Java inner classes to} express the desired behaviour of \Refinity{} in a straight-forward manner
