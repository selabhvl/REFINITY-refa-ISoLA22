...
\end{figure}
\vsnote{TODO: Find a better way to show global context like $p$ and class-diagram already here (like REFINITY's split views!}
...
\vsnote*{TODO: Ole/Eduard figure out postcondition?}{}
