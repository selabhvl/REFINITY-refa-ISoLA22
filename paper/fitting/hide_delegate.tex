...
To prove the specified \rname{Hide Delegate} refactoring in the published version (v0.9.7) of \Refinity{}, we need a postcondition consisting of a conjunction of return values of the before- and after-programs being identical and
