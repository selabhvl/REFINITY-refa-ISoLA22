...
location set \rcode{frN} of the AS present in \recode{n()} stating that \rcode{x} is not an element of \rcode{frN}. As such \recode{n()} should not be able to alter the value (a reference)
\recode{x} holds.
