...
Before and After program. When not left empty, as done here and so trivially true, equality wrt. the last component of the result sequences is an assertion that the values at all abstract location set selected as relevant are identical.}
