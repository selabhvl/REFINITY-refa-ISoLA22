...
The return value if any, otherwise null; exceptions thrown if any, otherwise null; and \vsnote*{Unclear (yes, I know what is meant). More constructive: ``an assertion that the values for all locations as per the relevant set are identical''?}{the final values at the relevant abstract locations specified}.
