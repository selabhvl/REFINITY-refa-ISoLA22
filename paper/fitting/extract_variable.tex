...
Before and After program. When left empty, as done here and so trivially true, equality wrt. the last component of the result sequences is an assertion that the values at all abstract location sets selected as relevant are identical.}
...
\OA{Although we succesfully prove the refactoring we have encoded here the required scaffolding of return statements leave something to be desired:
