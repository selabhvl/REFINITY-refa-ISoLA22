...
A main advantage of encoding the trace in the post state, is that relational verification (either based on product programs~\cite{product} or using the proof obligation described above),
