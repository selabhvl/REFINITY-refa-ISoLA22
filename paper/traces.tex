...
%In practice, 
Developers of Fowler's persuasion of what constitutes correct refactorings are content if refactored code gives the same observable behavior~\cite{fowler:refactoring2nd}.
