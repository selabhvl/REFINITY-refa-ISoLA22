...
A refactoring proof is a relational verification proof that compares two programs, \vsnote*{TODO: We'll have to rephrase this, I think. @Ole?}{which have the \emph{same} abstract statements}.
...
\Refinity{} \cite{steinhoefel:ae}, the tool supporting verification on top of the KeY system, \vsnote*{@Ole}{an automated theorem prover for Java\cite{needed}},
